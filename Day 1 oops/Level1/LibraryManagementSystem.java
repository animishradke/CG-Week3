...
public class LibraryManagementSystem {
    public static void main(String[] args) {
        ...
        itemList.add(new Book("B001", "The Lord of the Rings", "J.R.R. Tolkien", 1200));
        itemList.add(new Magazine("M002", "National Geographic", "Various", "April 2025"));
        itemList.add(new DVD("D003", "Inception", "Christopher Nolan", 148));
