...
public class HospitalManagementSystem {
    public static void main(String[] args) {
        ...
        System.out.println("Patient Billing Information:");
        System.out.println("==========================");
        ...
        System.out.println("Total Bill for " + inpatient.getName() + ": $" + String.format("%.2f", inpatient.calculateBill()));
        System.out.println("--------------------");

        Patient outpatient = new OutPatient("OP004", "Diana Miller", 28, 60.0, 120.0);
        outpatient.getPatientDetails();
        System.out.println("Total Bill for " + outpatient.getName() + ": $" + String.format("%.2f", outpatient.calculateBill()));
        System.out.println("--------------------");
